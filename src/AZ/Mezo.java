...
public class Mezo
{
	...
	boolean lineRect(double x1, double y1, double x2, double y2, double rx, double ry, double rw, double rh, double rot)
	{
		...
		double[][] vertices = { { -rw / 2, -rh / 2 }, { +rw / 2, -rh / 2 }, { +rw / 2, +rh / 2 },
				{ -rw / 2, +rh / 2 } };
	...
	public int Collision(double tx, double ty, double r /* float[] difs, */)
	{
		...
		if (zart[0])
		{
			boolean b = lineCircle(x * grid.intValue(), y * grid.intValue(), x * grid.intValue() + grid.intValue(),
					y * grid.intValue(), tx, ty, r);
			if (b)
			{
				ret = ret | 2;
			}
		...
		if (zart[1])
		{
			boolean b = lineCircle(x * grid.intValue(), y * grid.intValue(), x * grid.intValue(),
					y * grid.intValue() + grid.intValue(), tx, ty, r);
			if (b)
			{
				ret = ret | 1;
			}
		...
		if (zart[2])
		{
			boolean b = lineCircle(x * grid.intValue(), y * grid.intValue() + grid.intValue(),
					x * grid.intValue() + grid.intValue(), y * grid.intValue() + grid.intValue(), tx, ty, r);
			if (b)
			{
				ret = ret | 2;
			}
		...
		if (zart[3])
		{
			boolean b = lineCircle(x * grid.intValue() + grid.intValue(), y * grid.intValue(),
					x * grid.intValue() + grid.intValue(), y * grid.intValue() + grid.intValue(), tx, ty, r);
			if (b)
			{
				ret = ret | 1;
